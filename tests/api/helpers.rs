...
use zero2prod_axum::issue_delivery_worker::{try_execute_task, ExecutionOutcome};
...
impl TestApp {
    pub async fn post_subscriptions(&self, body: String) -> reqwest::Response {
        self.api_client
            .post(&format!("{}/subscriptions", &self.host))
    ...
    pub fn get_confirmation_links(&self, email_request: &wiremock::Request) -> ConfirmationLinks {
        ...
        let html = get_link(body["message"]["html"].as_str().unwrap());
    ...
    pub async fn get_publish_newsletter(&self) -> reqwest::Response {
        self.api_client
            .get(format!("{}/admin/newsletter", &self.host))
            .send()
            .await
            .expect("Failed to execute request.")
    }
    ...
    pub async fn get_admin_dashboard(&self) -> reqwest::Response {
        self.api_client
            .get(&format!("{}/admin/dashboard", &self.host))
            .send()
            .await
            .expect("Failed to execute request.")
    }
    ...
    pub async fn get_change_password(&self) -> reqwest::Response {
        self.api_client
            .get(&format!("{}/admin/password", &self.host))
            .send()
            .await
            .expect("Failed to execute request.")
    }
    ...
    {
        self.api_client
            .post(&format!("{}/admin/password", &self.host))
            .form(body)
            .send()
            .await
            .expect("Failed to execute request.")
    ...
    pub async fn post_logout(&self) -> reqwest::Response {
        self.api_client
            .post(&format!("{}/admin/logout", &self.host))
            .send()
            .await
            .expect("Failed to execute request.")
    }
...
pub async fn spawn_app() -> TestApp {
    ...
    let host = format!("http://127.0.0.1:{}", application.port());
